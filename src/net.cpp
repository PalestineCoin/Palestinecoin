...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Palestinecoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Palestinecoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Palestinecoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Palestinecoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
        {"palestinecoin.org", "178.33.129.219"},
        {"66.55.153.52", "66.55.153.52"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Palestinecoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Palestinecoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Palestinecoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Palestinecoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Palestinecoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Palestinecoin-start");
